                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" id="code" class="form-control"> </div>
                  </div>
                  <!--/span-->
                </div>
                <!--/row-->
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" placeholder="employee" aria-label="price" aria-describedby="basic-addon1" name="employee" id="employee" readonly>
                      </div>
                    </div>
                  </div>
                  <!--/span-->
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="price" aria-label="price" aria-describedby="basic-addon1" name="price" id="price">
                      </div>
                    </div>
                  </div>
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Unit</label>
                      <div class="input-group">
                        <input type="text" class="form-control" placeholder="unit" aria-label="price" aria-describedby="basic-addon1" name="unit" id="unit">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="el-element-overlay">
                      <div class="el-card-item">
                        <div class="el-card-avatar el-overlay-1"> <img src="<?= base_url('assets/'); ?>images/gallery/chair3.jpg" alt="user" />
                          <div class="el-overlay">
                            <ul class="list-style-none el-info">
                              <li class="el-item"><a class="btn default btn-outline image-popup-vertical-fit el-link" href="<?= base_url('assets/'); ?>images/gallery/chair3.jpg"><i class="sl-icon-magnifier"></i></a></li>
